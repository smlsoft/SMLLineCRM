...
export interface KnownProviderDef {
  ...
  authType: AiAuthType;
  /** Path to list-models endpoint relative to baseUrl. null = not supported */
  modelsPath: string | null;
  /** Whether the list-models endpoint requires authentication */
  modelsRequiresAuth: boolean;
  /** Extra headers to include in chat/completion requests */
...
export const KNOWN_PROVIDERS: KnownProviderDef[] = [
  ...
  {
    key: 'airouter',
    displayName: 'SML Router',
    defaultBaseUrl: 'https://airouter.satistang.com/v1',
    authType: 'bearer',
    modelsPath: null,
    modelsRequiresAuth: false,
  },
